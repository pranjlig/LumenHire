...
const Alert = (props) => {
    ...
    useEffect(() => {
        if (props.type === "error") {
            setTimeout(()=>{
                alertCtx.errorHandler("")
            }, 5000)
        } else {
            setTimeout(()=>{
                alertCtx.successHandler("")
            }, 5000)
        }       
    }, [])
    ...
    return (
            ...
            <div className={styles.alertDiv}>
                {props.type === "success" &&          
                    <div className="alert alert-success d-flex alert-dismissible fade show px-auto" role="alert">
                        <div className="">
                ...
                {props.type === "error" && 
                    <div className="alert alert-danger d-flex alert-dismissible fade show px-auto" role="alert">
                        <div>
